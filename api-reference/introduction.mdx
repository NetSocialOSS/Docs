...
All API endpoints are authenticated using Bearer tokens. These tokens are randomly generated and are assigned to the user when they signup this is used for Posting, Liking etc.
